...
header('location:'.SITEURL.'admin/manage-category.php');
 ...
 <form action="" method="POST"  enctype="multipart/form-data">
            ...
            <tr>
                ...
                <br><br>
                <td>
                    <input type="number" name="price" placeholder="enter your title" value="<?php echo $price ?>" >
                </td>
            </tr>
            <br><br>
            <tr>
...
if(isset($_POST['submit'])){
    ...
    $sql2 = "UPDATE `food` SET  `title` = '$title', price=$price, `featured` = '$featured', `img_name`='$img_name',  `active` = '$active' WHERE `id` = '$id' ";
